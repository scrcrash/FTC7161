...
#pragma config(Motor,  mtr_S1_C1_1,     motorTL,       tmotorTetrix, openLoop, reversed)
...
task baseGrip()
{
	while(true)
	{
		...
		//sets the servos up
		servo[servoGripLift1] = 0; //HANGE LATER
		servo[servoGripLift2] = 0;
		...
		//if (button) button pressed, servo brings goal grippers down
		else if(joy1Btn(2) == 1)
		{
			servo[servoGripLift1] = 180; //CHANGE LATER
			servo[servoGripLift2] = -180;
		}
